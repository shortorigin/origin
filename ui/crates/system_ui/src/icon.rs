...
impl IconName {
    ...
    fn svg_body(self) -> &'static str {
        match self {
            ...
            Self::Bell => {
                r#"<path d="M12 3.5a4.75 4.75 0 0 0-4.75 4.75v2.14c0 .8-.22 1.58-.64 2.26l-1.1 1.8A1.5 1.5 0 0 0 6.8 16.5h10.4a1.5 1.5 0 0 0 1.28-2.25l-1.1-1.8a4.3 4.3 0 0 1-.63-2.26V8.25A4.75 4.75 0 0 0 12 3.5Zm-3.25 4.75a3.25 3.25 0 1 1 6.5 0v2.14c0 1.08.29 2.14.85 3.07l.76 1.54H7.14l.76-1.54c.56-.93.85-1.99.85-3.07V8.25ZM10 18a2 2 0 1 0 4 0h-1.5a.5.5 0 1 1-1 0H10Z"/>"#
            }
            Self::Sun => {
                r#"<path d="M12 6a6 6 0 1 0 0 12 6 6 0 0 0 0-12Zm0 1.5a4.5 4.5 0 1 1 0 9 4.5 4.5 0 0 1 0-9Zm0-5.5a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5A.75.75 0 0 1 12 2Zm0 17a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5A.75.75 0 0 1 12 19Zm10-7.75a.75.75 0 0 1-.75.75h-1.5a.75.75 0 0 1 0-1.5h1.5a.75.75 0 0 1 .75.75Zm-17 0a.75.75 0 0 1-.75.75h-1.5a.75.75 0 0 1 0-1.5h1.5a.75.75 0 0 1 .75.75Zm12.3-5.8a.75.75 0 0 1 1.06 0l1.06 1.06a.75.75 0 0 1-1.06 1.06L17.6 6.5a.75.75 0 0 1 0-1.06Zm-11.66 11.66a.75.75 0 0 1 1.06 0l1.06 1.06a.75.75 0 1 1-1.06 1.06L5.94 18.97a.75.75 0 0 1 0-1.06Zm12.72 1.06a.75.75 0 0 1-1.06 0l-1.06-1.06a.75.75 0 1 1 1.06-1.06l1.06 1.06a.75.75 0 0 1 0 1.06ZM7 5.45A.75.75 0 0 1 7 6.5L5.94 7.56A.75.75 0 1 1 4.88 6.5L5.94 5.45A.75.75 0 0 1 7 5.45Z"/>"#
            }
            Self::Moon => {
                r#"<path d="M14.72 3.03a.75.75 0 0 1 .35 1.33 7.08 7.08 0 1 0 4.57 8.9.75.75 0 0 1 1.43.45 8.58 8.58 0 1 1-7.82-11.18c.5 0 1 .04 1.47.12Z"/>"#
            }
            Self::Search => {
                r#"<path d="M10.5 4a6.5 6.5 0 1 0 4.03 11.6l4.44 4.43a.75.75 0 1 0 1.06-1.06l-4.43-4.44A6.5 6.5 0 0 0 10.5 4Zm-5 6.5a5 5 0 1 1 10 0 5 5 0 0 1-10 0Z"/>"#
            }
        }
    }
}
