...
if [[ "${event_name}" == "merge_group" ]]; then
  ...
  while IFS= read -r file; do
    ...
    case "${file}" in
      .cargo/*|AGENTS.md|Cargo.toml|Cargo.lock|shared/*|enterprise/*|schemas/*|platform/*|services/*|workflows/*|ui/*|xtask/*|agents/*|testing/security-labs/*|docs/security-rust/examples/*|.github/workflows/*|.github/scripts/*)
        rust_changed=true
        ;;
    esac
